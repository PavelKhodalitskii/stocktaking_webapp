...
def debug_prepare():
    ...
    try: 
        ...
        superuser = CustomUser(username="admin", first_name="Админ", last_name="Админов", is_staff=True, is_superuser=True, is_active=True, is_admin=True, is_stocktalking_responsible=True)
